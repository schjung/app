...
public class CloudTextRecognitionProcessor extends VisionProcessorBase<FirebaseVisionText> {
    ...
    public CloudTextRecognitionProcessor(String text_color, String text_size) {
        super();
...
//                    Log.e(TAG, "zhCheck zhCheck zhCheck zhCheck 333333333333:: " + zhCheck);
                    ...
                    // Log.e(TAG,"textSum textSum textSum textSumtSum :: "+" ii "+ii+"  jj "+jj+"  ll  "+ll+"  ::  "+textSum);
                        ...
                        if(zhCheck) {
                         ...
                         //xtorm
                            // xLog.e(TAG, "text text text text 999999999999999999999999999999999999999999999999999999:: " + text);
