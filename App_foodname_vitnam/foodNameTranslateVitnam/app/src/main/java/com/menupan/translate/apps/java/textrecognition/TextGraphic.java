...
public class TextGraphic extends GraphicOverlay.Graphic {
  ...
  TextGraphic(GraphicOverlay overlay, FirebaseVisionText.Element text, String twText,String text_color, String text_size) {
    super(overlay);
  ...
  public void draw(Canvas canvas) {
    ...
    canvas.drawText(koText, rect.left, rect.bottom, textPaint);
  }
}
