 ...
 */
public class CloudTextEnRecognitionProcessor extends VisionProcessorBase<FirebaseVisionText> {
    ...
    public CloudTextEnRecognitionProcessor(String text_color, String text_size) {
        super();
            ...
            for (int j = 0; j < lines.size(); j++) {
                ...
                for (int l = 0; l < elements.size(); l++) {
                    String sumText = "";
                            ...
                            CloudTextGraphic cloudTextGraphic = new CloudTextGraphic(graphicOverlayNew, elements.get(l), sumText, text_color, text_size, l);
